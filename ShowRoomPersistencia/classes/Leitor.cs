...
namespace ShowRoomPersistencia.classes
{
    public class Leitor : IDisposable
    {
        ...
        /// </summary>
        /// <param name="field">nome do campo, exemplo: "nm_usuario"</param>
        ...
        /// </summary>
        /// <param name="field">nome do campo, exemplo: "id_cliente"</param>
        ...
        /// </summary>
        /// <param name="field">nome do campo, exemplo: "vl_valor"</param>
        ...
        /// </summary>
        /// <param name="field">nome do campo, exemplo: "dt_inc"</param>
        ...
        /// </summary>
        /// <param name="field">nome do campo, exemplo: "tp_ativo"</param>
